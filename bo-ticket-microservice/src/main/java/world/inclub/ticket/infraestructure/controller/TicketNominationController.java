...
public class TicketNominationController {
    ...
    // This is only useful if the qr was not generated well
    @PostMapping("/resend")
    public Mono<ResponseEntity<Object>> renominate(@RequestBody List<UUID> ticketUuids) {
        return ResponseHandler.generateResponse(HttpStatus.OK, ticketNominationService.renominateTicket(ticketUuids), true);
    }
