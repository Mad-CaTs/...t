...
@Component({
	selector: 'app-modal-reject-travel',
	standalone: true,
	imports: [CommonModule, ReactiveFormsModule, InlineSVGModule, ModalComponent, FormControlModule],
	templateUrl: './modal-reject-travel.component.html',
	styleUrls: ['./modal-reject-travel.component.scss']
})
export class ModalRejectTravelComponent {
	...
	private loadReasons(): void {
		this.MotiveOpt = [
			...
			{ id: '2', text: 'El bono viaje ya fue usado', typeReason: 2 }
		];
	}
