...
@Component({
	selector: 'app-modal-proforma-estate',
	standalone: true,
	imports: [CommonModule, ModalComponent, ReactiveFormsModule, FormControlModule],
	templateUrl: './modal-proforma-estate.component.html',
	styleUrls: ['./modal-proforma-estate.component.scss']
})
export class ModalPromformaEstateComponent {
	@Input() data: any;
