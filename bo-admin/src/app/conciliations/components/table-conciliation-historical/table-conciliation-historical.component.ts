...
@Component({
	selector: 'app-table-conciliation-historical',
	templateUrl: './table-conciliation-historical.component.html',
	styleUrls: ['./table-conciliation-historical.component.scss']
})
export class TableConciliationHistoricalComponent {
	@Input() tableData: any[] = [];
