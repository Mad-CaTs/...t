...
@Component({
  selector: 'app-modal-filtro-rango-personalizado',
  templateUrl: './modal-filtro-rango-personalizado.component.html',
  styleUrls: ['./modal-filtro-rango-personalizado.component.scss']
})
export class ModalFiltroRangoPersonalizadoComponent {
