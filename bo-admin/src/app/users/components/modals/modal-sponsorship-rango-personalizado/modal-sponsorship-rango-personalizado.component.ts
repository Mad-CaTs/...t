...
@Component({
  selector: 'app-modal-sponsorship-rango-personalizado',
  templateUrl: './modal-sponsorship-rango-personalizado.component.html',
  styleUrls: ['./modal-sponsorship-rango-personalizado.component.scss']
})
export class ModalSponsorshipRangoPersonalizadoComponent {
