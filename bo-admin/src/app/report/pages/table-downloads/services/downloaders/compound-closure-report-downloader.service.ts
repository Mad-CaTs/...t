...
export class CompoundClosureReportDownloader extends BaseReportDownloader {
    ...
    async download(params?: DownloadParams): Promise<ReportDownloadResult> {
        ...
        const downloadObservable = this.downloadCompoundClosuresReport(params);
    ...
    generateFilename(params?: DownloadParams): string {
        const baseFilename = 'cierre_compuesto';
                            ...
                            <div class="card border border-primary">
                                <div class="card-header bg-light-primary border-primary">
                                    <h6 class="card-title fw-bold text-primary mb-0">
                                        ...
                                        Períodos válidos para Cierre Compuesto
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
    ...
    /**
     * Descarga el reporte de cierre compuesto
     * 
     * Utiliza POST /api/v1/reports/compound-closures/download
     ...
     */
    private downloadCompoundClosuresReport(params?: DownloadParams): Observable<Blob> {
        const url = `${this.baseUrl}/reports/compound-closures/download`;
