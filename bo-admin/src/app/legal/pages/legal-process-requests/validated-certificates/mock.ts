import { IValidatedCertificatesRequest } from '@interfaces/legal-module.interface';

export const MOCK_VALIDATED_CERTIFICATE_REQUESTS: IValidatedCertificatesRequest[] = [
    {
        id: 1,
        numberDoc: '74589612',
        typeDoc: 'DNI',
