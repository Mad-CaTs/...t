...
@Component({
	selector: 'app-table-exoneration-validator',
	templateUrl: './table-exoneration-validator.component.html',
	styleUrls: ['./table-exoneration-validator.component.scss']
})
export class TableExonerationValidatorComponent implements OnInit, OnChanges {
	@Input() tableData: any[] = [];
