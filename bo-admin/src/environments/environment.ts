...
export const environment = {
	/* === Api's === */
	api: 'https://adminpanelapi.inclub.world',
	apiLocal: 'http://localhost:8070',
	apiReportsLocal: 'http://localhost:8080/api/v1',
	apiWallet: 'https://walletapi.inclub.world',
	apiCommission: 'https://commissionsapi.inclub.world',
	apiTree: 'https://treepointrangeapi.inclub.world',
	apiLegal: 'https://legalapi-dev.inclub.world',
	apiPdf: 'https://pdfapi-dev.inclub.world',
	apiCollaborators: 'https://collaboratorsapi.inclub.world',
	apiCupons: 'https://membershipapi-dev.inclub.world/api/v1/coupons',
	jobstatusapi: 'https://jobstatusapi.inclub.world/api/v1',
	SubscriptionApi: 'https://inclub-world-subscription-nevbnjzxaq-uc.a.run.app/api/v1',
	CommonApi: 'https://commonapi.inclub.world/api/v1',
	apiUrlTransfer: 'https://transferapi.inclub.world/api/v1',
	BonusApi: 'https://bonusesrewardsapi.inclub.world/api/v1',
	TicketApi: 'https://ticketapi.inclub.world',
	apireports: 'https://reportingapi.inclub.world/api/v1',
	/* === Metronic === */
	production: false,
	appVersion: 'v8.0.34',
