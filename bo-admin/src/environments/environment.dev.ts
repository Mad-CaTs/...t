...
export const environment = {
	api: 'https://adminpanelapi-dev.inclub.world',
	apiLocal: 'http://localhost:8080',
	apiWallet: 'https://walletapi-dev.inclub.world',
	apiCommission: 'https://commissionsapi-dev.inclub.world',
	apiTree: 'https://treepointrangeapi-dev.inclub.world',
	apiCollaborators: 'https://collaboratorsapi-dev.inclub.world',
	apiLegal: 'https://legalapi-dev.inclub.world',
	apiPdf: 'https://pdfapi-dev.inclub.world',
	jobstatusapi: 'https://jobstatusapi-dev.inclub.world/api/v1',
	apireports: 'https://reportingapi-dev.inclub.world/api/v1',
