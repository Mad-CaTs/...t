...
@Component
public class PrequalificationExcelResponseMapper {

    public PrequalificationExcelResponse toResponse(PrequalificationSummary summary) {
        return PrequalificationExcelResponse.builder()
    ...
    public PagedData<PrequalificationExcelResponse> toResponse(PagedData<PrequalificationSummary> pagedData) {
