...
public interface SearchCarPaymentScheduleInitialsUseCase {

    /**
     * Searches for initial car payment schedules associated with a specific car assignment ID, with pagination support.
     *
     ...
     * @return A Mono emitting a PagedData object containing the list of initial car payment schedules
     * associated with the specified car assignment ID and pagination details.
     */
    Mono<PagedData<CarPaymentSchedule>> searchInitials(
