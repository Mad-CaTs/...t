...
public class CarQuotationController {
    ...
    private final AcceptCarQuotationUseCase acceptCarQuotationUseCase;
    ...
    public Mono<ResponseEntity<ApiResponse<String>>> acceptQuotation(@PathVariable UUID id) {
        return ResponseHandler.generateResponse(
                HttpStatus.OK,
                acceptCarQuotationUseCase.acceptQuotation(id)
                        .thenReturn("Quotation accepted successfully"),
                true
        );
    }
