...
public interface SearchCarPaymentSchedulesUseCase {
     ...
     * @param numberOfInstallments Optional filter for the number of installments.
     * @param statusCode           Optional filter for the status code of the payment schedules.
     ...
     */
    Mono<PagedData<CarPaymentSchedule>> searchCarPaymentSchedules(
