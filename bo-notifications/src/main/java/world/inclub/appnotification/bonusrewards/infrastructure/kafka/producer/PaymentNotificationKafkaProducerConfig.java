...
public class PaymentNotificationKafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, PaymentNotificationMessage> paymentNotificationProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PaymentNotificationMessage> paymentNotificationKafkaTemplate() {
