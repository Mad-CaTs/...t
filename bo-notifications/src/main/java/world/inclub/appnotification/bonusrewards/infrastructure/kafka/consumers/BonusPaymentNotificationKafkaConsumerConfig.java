...
@Configuration
public class BonusPaymentNotificationKafkaConsumerConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ConsumerFactory<String, PaymentNotificationMessage> bonusPaymentNotificationConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PaymentNotificationMessage> bonusPaymentNotificationKafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(bonusPaymentNotificationConsumerFactory());
        return factory;
    }
}
