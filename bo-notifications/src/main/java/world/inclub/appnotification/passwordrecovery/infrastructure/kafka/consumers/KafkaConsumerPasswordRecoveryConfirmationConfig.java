...
@Configuration
public class KafkaConsumerPasswordRecoveryConfirmationConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ConsumerFactory<String, NotificationMessage> passwordRecoveryConfirmationConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NotificationMessage> passwordRecoveryConfirmationKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, NotificationMessage> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(passwordRecoveryConfirmationConsumerFactory());
        return factory;
    }
