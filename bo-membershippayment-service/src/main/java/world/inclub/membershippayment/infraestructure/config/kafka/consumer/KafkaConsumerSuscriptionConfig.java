...
public class KafkaConsumerSuscriptionConfig {
    ...
    @Bean
    public ConsumerFactory<String, SuscriptionDTO> suscriptionConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(configProps, new StringDeserializer(),
                new JsonDeserializer<>(SuscriptionDTO.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SuscriptionDTO> suscriptionKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, SuscriptionDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
