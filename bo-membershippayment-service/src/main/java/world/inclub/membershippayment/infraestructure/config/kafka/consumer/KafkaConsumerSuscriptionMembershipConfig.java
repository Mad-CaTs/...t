...
@Configuration
public class KafkaConsumerSuscriptionMembershipConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ConsumerFactory<String, Suscription> suscriptionMembershipConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(configProps, new StringDeserializer(),
                new JsonDeserializer<>(Suscription.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Suscription> suscriptionMembershipKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Suscription> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(suscriptionMembershipConsumerFactory());
        return factory;
    }
}
