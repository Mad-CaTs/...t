package world.inclub.membershippayment.crosscutting.circuitBreaker;
...
public class ResilienceConfig {
    ...
    public static final String CIRCUIT_BREAKER_CONFIG_NAME = "testService";// cambiar nombre
    public static final String RETRY_CONFIG_NAME = "testService";// cambiar nombre
    @Bean
