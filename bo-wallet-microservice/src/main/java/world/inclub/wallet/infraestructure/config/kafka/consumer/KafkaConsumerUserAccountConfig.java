...
@Configuration
public class KafkaConsumerUserAccountConfig {

     @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ConsumerFactory<String, UserAccountDTO> userAccountConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserAccountDTO> userAccountKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, UserAccountDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(userAccountConsumerFactory());
        return factory;
    }
