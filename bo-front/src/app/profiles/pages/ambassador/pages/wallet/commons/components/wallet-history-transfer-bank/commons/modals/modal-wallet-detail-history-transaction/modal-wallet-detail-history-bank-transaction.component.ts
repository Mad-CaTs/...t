...
@Component({
	selector: 'app-modal-wallet-detail-history-bank-transaction',
	templateUrl: './modal-wallet-detail-history-bank-transaction.component.html',
	standalone: true,
	imports: [CommonModule, ModalComponent],
	providers: [DatePipe],
	styleUrls: []
})
export class ModalWalletDetailHistoryBankTransactionComponent implements OnInit {
	@Input() id: number = 0;
