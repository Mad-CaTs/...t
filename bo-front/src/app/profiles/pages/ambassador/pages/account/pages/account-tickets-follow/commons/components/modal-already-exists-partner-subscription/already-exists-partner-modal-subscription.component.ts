...
@Component({
  selector: 'app-already-exists-partner-modal-subscription',
  standalone: true,
  imports: [
    CommonModule,
    ModalComponent,
  ...
  templateUrl: './already-exists-partner-modal-subscription.component.html',
  styleUrls: [],
})
export class AlreadyExistsPartnerSubscriptionModalComponent implements OnInit {
  @Input() id: number = 0;
