...
@Component({
  selector: 'app-modal-transfer-new-partner-subscription',
  templateUrl: './modal-transfer-new-partner-subscription.component.html',
  standalone: true,
  imports: [CommonModule, ModalComponent, AccountNewPartnerModalComponent, SelectComponent],
  styleUrls: [],
})
export class ModalTransferNewPartnerSubscriptionComponent implements OnInit {
  @Input() id: number = 0;
