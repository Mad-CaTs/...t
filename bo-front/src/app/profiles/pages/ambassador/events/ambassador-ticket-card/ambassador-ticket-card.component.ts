...
@Component({
  ...
  templateUrl: './ambassador-ticket-card.component.html',
  styleUrl: './ambassador-ticket-card.component.scss'
})
export class AmbassadorTicketCardComponent implements OnInit {
