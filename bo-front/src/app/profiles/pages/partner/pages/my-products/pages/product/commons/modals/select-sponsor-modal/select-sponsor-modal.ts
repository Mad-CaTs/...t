...
import { TransferLiquidationService } from 'src/app/profiles/pages/ambassador/pages/account/pages/account-tickets-follow/commons/service/transfer-liquidation-package.service';
import { DialogService } from 'primeng/dynamicdialog';

@Component({
  selector: 'app-select-sponsor-modal',
  standalone: true,
  ...
  templateUrl: './select-sponsor-modal.html',
  styleUrls: [],
})
export class SelectSponsorModal implements OnInit {
  @Input() id: number = 0;
  ...
  public profileOpt: ISelect[] = [{value: 1, content: "test profile"}];
