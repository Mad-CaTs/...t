...
@Component({
  selector: 'guest-ticket-card-partner',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './partner-ticket-card.component.html',
  styleUrl: './partner-ticket-card.component.scss'
})
export class PartnerTicketCardComponent implements OnInit {
  ...
  onNominate(event: Tickets): void {
    ...
    if (paymentId) {
      this.router.navigate(
        ['/profile/ambassador/events/my-tickets/detail', paymentId]
      );
      return;
    }
