...
import { ModalLegalizationRequest } from '../../../../../../commons/modals/modal-legalization-request/modal-legalization-request';
...
export class MyLegalizationTableComponent implements OnInit {
	...
	openLegalizationRequestModal(element: any): void {
      ...
      listLegalDocuments.forEach((doc: any, index: number) => {
        doc.generatedLink = results[index].url;
        doc.idDocument = results[index].id;
        doc.numberSerial = results[index].serial;
      });
