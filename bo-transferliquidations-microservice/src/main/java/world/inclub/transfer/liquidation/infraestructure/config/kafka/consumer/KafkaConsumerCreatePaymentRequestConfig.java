...
@Configuration
public class KafkaConsumerCreatePaymentRequestConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ConsumerFactory<String, PaymentDto> createPaymentConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PaymentDto> createPaymentKafkaListenerContainerFactory() {
